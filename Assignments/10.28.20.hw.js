...
// function replaceA (replacing){
//     return replacing.replace(/a/gi , '-')
// }
// console.log(replaceA('Anniversary'));
...
// function characterAt (Hello){
//     return Hello.charAt([5])
// }
//  console.log(characterAt('Amazing'))
...
// function theLength(param1){
//     return param1.length

// }
// console.log(theLength('Jasmine is an Athelete')); 
...
//  function lastChar(param2){
//      return param2[param2.length -1]
//  }
// console.log(lastChar('Software'));
...
// let food = ['pizza', 'burger', 'fries', 'sandwich']
// let utensils = ['plate', 'fork', 'spoon', 'knife']

// function itConcats (param1, param2){
//     return food.concat(utensils)
// }
// console.log(itConcats(food, utensils));
