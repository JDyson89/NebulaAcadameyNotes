...
// function upperCase(Chelsea){
//     return Chelsea.toUpperCase()
// }
...
function lastElement (oneCounty){
    
    return `the last element in the array is ${oneCounty}`
}
console.log(lastElement(counties[5]));
...
function favoriteCountry (favCountry){
    return `My favorite country is ${favCountry}`
}
console.log(favoriteCountry('Puerto Rico'));
